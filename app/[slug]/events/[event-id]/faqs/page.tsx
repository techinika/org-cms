...
export default function EventFaqsPage({ params }: Props) {
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Breadcrumb items={[
          ...
          { label: "FAQs", href: `/${slug}/events/${eventId}/faqs` },
        ]} />
        ...
        {faqs.length === 0 ? (
          <div className="bg-white rounded-2xl border border-gray-200 p-12 text-center">
            ...
            <h2 className="text-xl font-semibold text-gray-900 mb-2">No FAQs added</h2>
            <p className="text-gray-500 max-w-sm mx-auto">Add frequently asked questions to help attendees understand your event.</p>
          </div>
        ) : (
      ...
      {showForm && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative bg-white rounded-2xl w-full max-w-lg p-6">
            <h2 className="text-lg font-semibold mb-4">{editingIndex !== null ? "Edit FAQ" : "Add FAQ"}</h2>
            ...
            <div className="flex gap-3 mt-6">
              <button onClick={resetForm} className="flex-1 px-4 py-2 text-gray-700 bg-gray-100 rounded-xl hover:bg-gray-200">Cancel</button>
              <button
                onClick={handleSave}
